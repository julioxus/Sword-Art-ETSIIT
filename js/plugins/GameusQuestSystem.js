...
//---------------------------------------------------------------------------------------------
	...
	// Removes all the quest from the party. NOTE: This does NOT reset the quest
    Game_Party.prototype.clearQuests = function() {
...
//---------------------------------------------------------------------------------------------
    ...
    Window_QuestInfo.prototype.drawQuestSteps = function(q) {
        ...
        this.questBitmap.textColor = this.systemColor(); 
        this.questBitmap.drawText(GameusScripts["Config"]["QuestSystem"]["Steps Word"], 0, this.lineY, this.contentsWidth(), this.lineHeight());
        this.write();
        this.questBitmap.textColor = this.normalColor();
    ...
    Window_QuestInfo.prototype.drawQuestRewards = function(q) {
        ...
        // Draw Rewards
        this.questBitmap.textColor = this.systemColor(); 
        this.questBitmap.drawText(GameusScripts["Config"]["QuestSystem"]["Rewards Word"], 0, this.lineY, this.contentsWidth(), this.lineHeight());
        this.write();
        this.questBitmap.textColor = this.normalColor();
...
//---------------------------------------------------------------------------------------------
    ...
    Window_QuestFilter.prototype.initialize = function() {
        this.qFilters = [
			...
			GameusScripts["Config"]["QuestSystem"]["Steps Word"] || "Steps",
